...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "devmanish1923008@gmail.com",
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[var(--color-surface)] rounded-xl border border-[var(--color-boder)] focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-[var(--color-surface)] rounded-xl border border-[var(--color-boder)] focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)] outline-none transition-all resize-none"
                />
              </div>
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            ...
            <div className="glass rounded-3xl p-8 border border-[var(--color-primary)]/30">
              ...
              <p className="text-[var(--color-muted-foreground)] text-sm">
                ...
                Whether you need a full-time Full stack web developer
                let's talk!
              </p>
            </div>
          </div>
